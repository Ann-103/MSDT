...
def cloud_init(account_from, contract_address, value, verifyResult):
    ...
    init_tx = trading_contract.functions.cloudInit(verifyResult).build_transaction(
        {
    ...
    print("cloudInit:",tx_receipt["gasUsed"])
    return tx_receipt
...
if __name__ == "__main__":
    ...
    verifyResult = [hex(verifyResult_i)]
    cloud_init(account_from, contract_address, value, verifyResult)
