...
def request_service(account_from, contract_address, value, setSeq, payNum, payHash ):
    ...
    init_tx = trading_contract.functions.requestService(setSeq, payNum, payHash).build_transaction(
        {
    ...
    print("requestService:",tx_receipt["gasUsed"])
    return 0
...
if __name__ == "__main__":
    ...
    contract_address = '0x8c28ffb6d25b60f1522411c7850BF336b5af3239'
    value = 0
    setSeq = [0]
    payNum = 1
    ...
    request_service(account_from, contract_address, value, setSeq, payNum, payHash )
