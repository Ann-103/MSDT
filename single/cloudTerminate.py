...
def cloud_terminate(account_from, contract_address, value, paySeed, setNum ):
    ...
    init_tx = trading_contract.functions.cloudTerminate(paySeed, setNum).build_transaction(
        {
    ...
    print("cloudTerminate:",tx_receipt["gasUsed"])
...
if __name__ == "__main__":
    ...
    value = 0
    paySeed = "0x19b25856e1c150ca834cffc8b59b23adbd0ec0389e58eb22b3b64768098d002b"
    setNum = 1
    cloud_terminate(account_from, contract_address, value, paySeed, setNum )
